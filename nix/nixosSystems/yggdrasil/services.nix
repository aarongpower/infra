{
  ...
  # some shims, mainly for the bgp/proxmox terraform provider to work properly
  systemd.tmpfiles.rules = [
    ...
    "L /sbin/pvesm - - - - /run/current-system/sw/bin/pvesm"
    "L /sbin/qm - - - - /run/current-system/sw/bin/qm"
  ];
